...
private:
	...
	QString m_aiApiKey;
	QString m_aiModel;
	QString m_aiUserBubbleColor = QStringLiteral("#2563eb");
	QString m_aiAiBubbleColor = QStringLiteral("#ffffff");
	QString m_aiChatBgColor = QStringLiteral("#f3f4f6");
	QString m_imagePoolToolbarColor = QStringLiteral("#000000");
	QString m_aiFontFamily;
	int m_aiFontSize = 13;
	QString m_aiTextColor = QStringLiteral("#374151");
	QString m_userTextColor = QStringLiteral("#ffffff");
	QString m_aiSystemBubbleColor = QStringLiteral("#fef3c7");
	QString m_aiSystemTextColor = QStringLiteral("#92400e");
	QString m_aiSenderColor = QStringLiteral("#9ca3af");
	QString m_aiSystemSenderColor = QStringLiteral("#d97706");
